...
|[logsource-mapping-registry](logsource-mapping-registry/)| Chứa field map cho các logsource theo chuẩn OSCF |
|[rule-view](rule-view/)| Chứa layer giữa rule và field mapping nhằm map rule field và log field |
|[rules](rules/)| Chứa các detection rules độc lập SIEM, được deploy tới các SIEM |
